...
<div class="container">
	...
	<form id="updateMemberPwForm" method="post" action="./updateMemberPwAction.jsp">
			  ...
			  <h1>관리자 페이지 - 비밀번호 수정</h1>
				...
				<table class="table table-borderless table-hover">
						...
						<tr class="border-bottom font-weight-bold">					
							...
							<td><input id="memberPw" type="text" class="text-center" name="memberPw" value="<%=member.getMemberPw() %>"></td>					
						</tr>
						<tr class="border-bottom font-weight-bold">					
		...
		<div class="text-center">
			<button id="updatePwBtn" type="button" class="btn btn-outline-dark">수정</button>
	...
	<script>
		$('#updatePwBtn').click(function() {
			if($('#memberPw').val() == '') {
				...
				$('#updateMemberPwForm').submit(); // <button type="button"> -> <button type="submit">
			}
		})
	</script>
</body>
